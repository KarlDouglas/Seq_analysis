...
BC8.F = main.count_nucleotides("BC8.F.map")
...
BC8.F_mutations = main.calculate_mutations((BC8.F))
...
plt.savefig("BC8.png")
BC8.F_plot = main.plot_mutation_base_proberbility(BC8.F, BC8.F_mutations)
